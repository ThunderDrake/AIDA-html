...
function moveLogoPattern1() {
  ...
  if(document.querySelector(".call-bg-logo-wrap1")){
...
window.addEventListener("scroll", () => {
  ...
  let cardItem1 = selectAll(".splide__slide"),
    img1 = selectAll(".splide__slide img");
  gsap.set(img1, { scale: 1.1, transformOrigin: "center center" }),
    ...
    let callItem1 = gsap.utils.toArray(".call-item"),
      infoCallItem1 = gsap.utils.toArray(".call-info-item");
    function moveLogoPattern() {
      let e = gsap.timeline({
        scrollTrigger: {
          id: "Pattern",
    ...
    infoCallItem1[0].classList.add("is-active"),
      callItem1[0].classList.add("is-active"),
      callItem1.forEach((t, r) => {
        t.addEventListener("mouseenter", (e) => {
          infoCallItem1.forEach((e) => {
            e.classList.remove("is-active");
          }),
            callItem1.forEach((e) => {
              e.classList.remove("is-active");
            ...
            t.classList.add("is-active"),
            infoCallItem1[r].classList.add("is-active");
        });
      }),
      $(".slider-main-component").each(function (e) {
        let t = !1;
